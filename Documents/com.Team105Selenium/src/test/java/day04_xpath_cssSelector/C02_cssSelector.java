...
public class C02_cssSelector {
    public static void main(String[] args) throws InterruptedException {
        ...
        WebElement urunUcretelementi=driver.findElement(By.xpath("(//span[text()='$25.00'])[2]"));
        String expectedUcret="$25.00";
        String actualUcretYazisi= urunUcretelementi.getText();
        if (expectedUcret.equals(actualUcretYazisi)) {
            System.out.println("Gift card ucreti PASSED");
        }else{
            System.out.println("Gift card ucreti FAILED");}
