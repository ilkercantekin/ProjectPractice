...
public class C02_ZeroTest {
    public static void main(String[] args) {
        ...
        //6. navigate back yapıp online banking yapıp Pay Bills sayfasina gidin
        ...
        WebElement succesffullyElementi=driver.findElement(By.id("alert_content"));
        if (succesffullyElementi.isDisplayed()){
